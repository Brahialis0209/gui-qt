...
### Пример
![gui](images/example1_widgets.png "Следующая задача была взята как пример")<br><br><br>
![gui](images/example1_graph.png "Тут можно увидеть начальное приближение а также
